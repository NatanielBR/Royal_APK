...
import {NavigationContainer, useNavigation, NavigationProp, StackActions} from '@react-navigation/native';
...
function FilmD() {
    return (<Stack.Navigator initialRouteName="Filmes">
        <Stack.Screen
            name="Filmes"
            component={Filmes}
    ...
    return (<Tab.Navigator
        ...
        screenOptions={{
            tabBarStyle: {
                ...
                backgroundColor: Color.tabColor, ...styles.shadow,
        ...
        <Tab.Screen
            ...
            component={HomeD}
            options={{
                headerShown: false, tabBarIcon: ({focused}) => (<TouchableOpacity
                    onPress={() => {
                    ...
                    <View style={styles.tabPart}>
                        <Image
                            ...
                            style={{
                                width: 23,
                                height: 23,
                                tintColor: focused ? `${Color.tabActive}` : `${Color.tabInactive}`,
                            }}
                        />
                        <Text
                            style={{
...
const styles = StyleSheet.create({
    shadow: {
        ...
        alignItems: 'center', justifyContent: 'center', top: 1,
    },
});
